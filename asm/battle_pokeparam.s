...
_021D583C:
	...
	thumb_func_start BattleMon_GetPokemon
BattleMon_GetPokemon: ; 0x021D5844
	ldr r0, [r0]
	bx lr
	thumb_func_end BattleMon_GetPokemon

	thumb_func_start BattleMon_SetIllusionMon
BattleMon_SetIllusionMon: ; 0x021D5848
	ldrb r2, [r0, #0x1b]
	str r1, [r0, #4]
	mov r1, #0x40
	orr r1, r2
	strb r1, [r0, #0x1b]
	bx lr
	thumb_func_end BattleMon_SetIllusionMon

	thumb_func_start BattleMon_ClearIllusionMon
BattleMon_ClearIllusionMon: ; 0x021D5854
	ldrb r2, [r0, #0x1b]
	mov r1, #0
	str r1, [r0, #4]
	mov r1, #0x40
	...
	bx lr
	.balign 4, 0
	thumb_func_end BattleMon_ClearIllusionMon

	thumb_func_start BattleMon_GetVisibleMon
BattleMon_GetVisibleMon: ; 0x021D5864
	ldr r2, [r0, #4]
	cmp r2, #0
	beq _021D5876
	ldrb r1, [r0, #0x1b]
	...
	add r0, r2, #0
	bx lr
	thumb_func_end BattleMon_GetVisibleMon
_021D5876:
	ldr r0, [r0]
	bx lr
	.balign 4, 0
...
_021D5DF4:
	...
	b _021D5E04
_021D5DF8:
	ldr r1, _021D5E30 ; =0x00000101
	b _021D5DF4
_021D5DFC:
	ldr r1, _021D5E34 ; =0x00000102
	b _021D5DF4
_021D5E00:
	mov r0, #0
	bx lr
...
_021D5E6C:
	...
	b _021D5E7C
_021D5E70:
	ldr r1, _021D5EA0 ; =0x00000101
	b _021D5E6C
_021D5E74:
	ldr r1, _021D5EA4 ; =0x00000102
	b _021D5E6C
_021D5E78:
	mov r0, #0
	bx lr
...
_021D5EDC:
	...
	b _021D5EEA
_021D5EE0:
	ldr r1, _021D5EF4 ; =0x00000101
	b _021D5EDC
_021D5EE4:
	ldr r1, _021D5EF8 ; =0x00000102
	b _021D5EDC
_021D5EE8:
	bx lr
_021D5EEA:
...
_021D74F4: .word 0x021F3ECC
	...
	.section .rodata, 4
	.global battle_pokeparam_rodata
battle_pokeparam_rodata:
_021F040C:
	.byte 0x03, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00
	.section .data, 4
	.global battle_pokeparam_data
battle_pokeparam_data:
_021F3AA4:
	.byte 0x62, 0x74, 0x6C, 0x5F, 0x70, 0x6F, 0x6B, 0x65, 0x70, 0x61, 0x72, 0x61, 0x6D, 0x2E, 0x63, 0x00
