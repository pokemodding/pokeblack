...
_021EFFD0:
	.byte 0xC0, 0x10, 0x1F, 0x02
_021EFFD4:
	.byte 0xE0, 0x30, 0x00, 0x00
_021EFFD8:
	.byte 0x38, 0x10, 0x1F, 0x02
_021EFFDC:
...
_021F00D0:
	.byte 0x50, 0x10, 0x00, 0x04, 0xF8, 0xB5, 0x05, 0x1C, 0x28, 0x68, 0x0F, 0x1C, 0x22, 0xF6, 0x2C, 0xF8
...
_021F0334:
	.byte 0x50, 0x10, 0x1F, 0x02
_021F0338:
	.byte 0x70, 0x10, 0x1F, 0x02
_021F033C:
	.byte 0x90, 0x10, 0x1F, 0x02
_021F0340:
...
_021F0886:
	...
	arm_func_start switchdataD_overlay_d_31__021f0888
switchdataD_overlay_d_31__021f0888: ; 0x021F0888
	andeqs r0, r6, sl
	eoreq r0, r2, ip, lsl r0
	stcvs p0, c0, [r0], #0xa0
	arm_func_end switchdataD_overlay_d_31__021f0888
_021F0894:
	.byte 0x06, 0x21
...
_021F0D60:
	.byte 0xB0, 0xC2, 0x09, 0x02, 0x18, 0xB5, 0x83, 0xB0, 0x04, 0x1C, 0x01, 0xA8, 0x00, 0xA9, 0x44, 0xF6
...
_021F0F92: ; jump table
	.hword _021F0F9A - _021F0F92 - 2 ; case 0
	.hword _021F0F9A - _021F0F92 - 2 ; case 1
	.hword _021F0FA6 - _021F0F92 - 2 ; case 2
	.hword _021F0FA6 - _021F0F92 - 2 ; case 3
_021F0F9A:
	cmp r5, #0
	bne _021F0FA2
	mov r0, #0
...
_021F102C:
	...
	nop
_021F1030:
	.byte 0x1C, 0x35, 0x00, 0x00
_021F1034:
	.byte 0x20, 0x35, 0x00, 0x00
_021F1038:
