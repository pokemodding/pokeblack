...
_021B62FC:
	.byte 0x68, 0x6E, 0x1B, 0x02
_021B6300:
	.byte 0x80, 0x6D, 0x1B, 0x02
_021B6304:
	.byte 0x4D, 0x64, 0x1B, 0x02
...
_021B6428:
	.byte 0xB0, 0x6D, 0x1B, 0x02
_021B642C:
	.byte 0xFF, 0xCF, 0xFF, 0xFF
_021B6430:
	.byte 0xDF, 0xCF, 0x00, 0x00
_021B6434:
	.byte 0xD8, 0x6D, 0x1B, 0x02
...
_021B644C:
	...
	.byte 0x87, 0x44, 0x0A, 0x00, 0x18, 0x00, 0x38, 0x00, 0x4A, 0x00, 0x6E, 0x00, 0x80, 0x00, 0x60, 0x69
...
_021B6562:
	...
	nop
_021B6568:
	.byte 0x98, 0x6D, 0x1B, 0x02
_021B656C:
	.byte 0xC0, 0x6D, 0x1B, 0x02
_021B6570:
	.byte 0x51, 0x67, 0x1B, 0x02
_021B6574:
	.byte 0x79, 0x65, 0x1B, 0x02, 0x38, 0xB5
_021B657A:
	.byte 0x04, 0x1C, 0x20, 0x6E, 0x0B, 0x28
	.byte 0x4C, 0xD8, 0x00, 0x18, 0x78, 0x44, 0xC0, 0x88, 0x00, 0x04, 0x00, 0x14, 0x87, 0x44, 0x16, 0x00
...
_021B68D4:
	.byte 0x74, 0x6E, 0x1B, 0x02
_021B68D8:
	.byte 0x24, 0x6E, 0x1B, 0x02
...
_021B6A56: ; jump table
	.hword _021B6A64 - _021B6A56 - 2 ; case 0
	.hword _021B6A7E - _021B6A56 - 2 ; case 1
	.hword _021B6AB0 - _021B6A56 - 2 ; case 2
	.hword _021B6AD6 - _021B6A56 - 2 ; case 3
	.hword _021B6B10 - _021B6A56 - 2 ; case 4
	.hword _021B6B1E - _021B6A56 - 2 ; case 5
	.hword _021B6B52 - _021B6A56 - 2 ; case 6
_021B6A64:
	add r1, r4, #0
	add r1, #0x38
	ldrb r1, [r1]
...
_021B6CF2: ; jump table
	.hword _021B6D00 - _021B6CF2 - 2 ; case 0
	.hword _021B6D38 - _021B6CF2 - 2 ; case 1
	.hword _021B6CFC - _021B6CF2 - 2 ; case 2
	.hword _021B6D0C - _021B6CF2 - 2 ; case 3
	.hword _021B6D04 - _021B6CF2 - 2 ; case 4
_021B6CFC:
	mov r0, #1
	pop {r3, pc}
_021B6D00:
...
_021B6D4E:
	...
	nop
_021B6D70:
	.byte 0x50, 0x00, 0x00, 0x04, 0x5D, 0x61, 0x1B, 0x02, 0xA5, 0x61, 0x1B, 0x02, 0xC5, 0x61, 0x1B, 0x02
_021B6D80:
	.byte 0x00, 0x00
_021B6D82:
	.byte 0x00, 0x00
