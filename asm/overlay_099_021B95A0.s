...
_021B9A2C:
	.byte 0x21, 0xA5, 0x1B, 0x02
_021B9A30:
	.byte 0xD5, 0xA2, 0x1B, 0x02
...
_021BA20E:
	.byte 0x0A, 0x00
	.byte 0x0E, 0x00, 0x0E, 0x00, 0x0A, 0x00, 0x0A, 0x00, 0x0E, 0x00
_021BA21A:
	mov r0, #1
	bx lr
_021BA21E:
...
_021BA23C:
	.byte 0x19, 0xA4, 0x1B, 0x02
_021BA240:
	.byte 0xB5, 0xA5, 0x1B, 0x02
_021BA244:
	.byte 0xD1, 0xA2, 0x1B, 0x02
...
_021BA2C8:
	.byte 0x79, 0xA5, 0x1B, 0x02
_021BA2CC:
	.byte 0x6D, 0xA3, 0x1B, 0x02
_021BA2D0:
...
_021BA368:
	.byte 0x00, 0x00, 0xF4, 0xFF, 0xF8, 0xB5
_021BA36E:
	.byte 0x82, 0xB0
...
_021BA750:
	...
	nop
_021BA754:
	.byte 0x7C, 0x28, 0x1C, 0x02
_021BA758:
	.byte 0x7D, 0x28, 0x1C, 0x02
_021BA75C:
	.byte 0x7F, 0x28, 0x1C, 0x02
_021BA760:
	.byte 0x7E, 0x28, 0x1C, 0x02
...
_021BA800:
	.byte 0xE4, 0xA5, 0x03, 0x02, 0x00, 0x2B, 0x70, 0x47, 0x00, 0x2B, 0x70, 0x47, 0x00, 0x2B, 0x70, 0x47
...
_021BABD8:
	.byte 0x34, 0x13, 0x00, 0x00, 0x38, 0xB5, 0x05, 0x1C
...
_021BAD6C:
	.byte 0x00, 0x3B, 0x1C, 0x02
_021BAD70:
	.byte 0x50, 0x3A, 0x1C, 0x02
...
_021BAEB0:
	...
	pop {r4, r5, r6, r7, pc}
_021BAED0:
	.byte 0xA0, 0x37, 0x1C, 0x02
_021BAED4:
	.byte 0x30, 0x37, 0x1C, 0x02
_021BAED8:
	.byte 0x34, 0x13, 0x00, 0x00
...
_021BB99A:
	...
	nop
_021BB9B8:
	.byte 0x70, 0x3A, 0x1C, 0x02
_021BB9BC:
	.byte 0x4C, 0x13, 0x00, 0x00
_021BB9C0:
	.byte 0x68, 0x3B, 0x1C, 0x02
_021BB9C4:
	.byte 0xD0, 0x3A, 0x1C, 0x02
...
_021BB9E8:
	.byte 0x30, 0x3B, 0x1C, 0x02
_021BB9EC:
	.byte 0x34, 0x3B, 0x1C, 0x02
_021BB9F0:
	.byte 0x78, 0x3A, 0x1C, 0x02
...
_021BC330:
	...
	add pc, r0
_021BC342:
	.byte 0x16, 0x00, 0x12, 0x00, 0xC8, 0x00, 0xC8, 0x00, 0xC8, 0x00, 0xC8, 0x00, 0x1A, 0x00
	.byte 0x44, 0x00, 0x7C, 0x00, 0xC0, 0x00
_021BC356:
	add r0, r6, #0
	pop {r3, r4, r5, r6, r7, pc}
_021BC35A:
...
_021BC438:
	.byte 0x52, 0x13, 0x00, 0x00, 0x70, 0xB5
_021BC43E:
	.byte 0x9D, 0x24
...
_021BC494:
	...
	nop
_021BC4A4:
	.byte 0x53, 0x13, 0x00, 0x00, 0x70, 0xB5
_021BC4AA:
...
_021BC6DE:
	...
	nop
_021BC6F0:
	.byte 0x5C, 0x13, 0x00, 0x00, 0x70, 0xB5, 0x05, 0x1C, 0x0C, 0x1C, 0x80, 0xF6, 0x3E, 0xEE, 0x00, 0x28
...
_021BCA7A:
	...
	pop {r3, r4, r5, r6, r7, pc}
_021BCAB4:
	.byte 0x4E, 0x13, 0x00, 0x00, 0x38, 0xB5
_021BCABA:
...
_021BCC54:
	.byte 0xD9, 0xCB, 0x1B, 0x02, 0xF0, 0xB4, 0x02, 0x22, 0x92, 0x07, 0x0A, 0x42
...
_021BCD54:
	.byte 0x42, 0x02, 0x00, 0x00, 0x78, 0xB5
_021BCD5A:
...
_021BD00C:
	...
	pop {r3, r4, r5, pc}
_021BD010:
	.byte 0x5C, 0x13, 0x00, 0x00, 0x38, 0xB5
_021BD016:
...
_021BD1A0:
	.byte 0x54, 0x13, 0x00, 0x00, 0xF0, 0xB5, 0x83, 0xB0, 0x6E, 0x26, 0x04, 0x1C, 0xB6, 0x00, 0xA0, 0x59
...
_021BD314:
	.byte 0x48, 0x13, 0x00, 0x00, 0xF8, 0xB5
_021BD31A:
...
_021BD674:
	.byte 0x57, 0x13, 0x00, 0x00, 0x38, 0xB5
_021BD67A:
	.byte 0x05, 0x1C, 0x0C, 0x1C, 0xFD, 0xF7
...
_021BD7D0:
	.byte 0x5C, 0x13, 0x00, 0x00, 0x73, 0x22
_021BD7D6:
...
_021BD974:
	.byte 0x52, 0x13, 0x00, 0x00
_021BD978:
	.byte 0x06, 0x0A, 0x00, 0x00, 0x04, 0x4A
_021BD97E:
	.byte 0x5E, 0x23
	.byte 0x83, 0x54, 0x73, 0x22, 0x8A, 0x23, 0x92, 0x00, 0x83, 0x50, 0x08, 0x1C, 0x70, 0x47, 0xC0, 0x46
_021BD990:
...
_021BDD36:
	...
	nop
_021BDD40:
	.byte 0x00, 0xE4, 0x05, 0x00
_021BDD44:
	.byte 0x9C, 0x3B, 0x1C, 0x02
...
_021BDD70:
	.byte 0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x1C, 0x00
	.byte 0x1C, 0x00, 0x1C, 0x00, 0x1C, 0x00, 0x1C, 0x00, 0x1C, 0x00, 0x1C, 0x00, 0x1C, 0x00
caseD_9:
	mov r0, #1
	bx lr
_021BDD92:
...
_021BDE6C:
	...
	.byte 0x0C, 0x00, 0x18, 0x00, 0x18, 0x00, 0x0C, 0x00, 0x18, 0x00
_021BDE7A:
	blx FUN_020399A8
	mov r1, #1
	blx FUN_0203D1E8
...
_021BDFC0:
	...
	pop {r3, r4, r5, pc}
_021BE024:
	.byte 0x98, 0x08, 0x00, 0x00, 0x00, 0x4B
_021BE02A:
	.byte 0x18, 0x47
_021BE02C:
...
_021BE1B2:
	...
	nop
_021BE1F0:
	.byte 0xF4, 0x37, 0x1C, 0x02
_021BE1F4:
	.byte 0x6C, 0x39, 0x1C, 0x02
_021BE1F8:
	.byte 0x2C, 0x38, 0x1C, 0x02
_021BE1FC:
	.byte 0x4C, 0x38, 0x1C, 0x02
_021BE200:
	.byte 0x6C, 0x38, 0x1C, 0x02
_021BE204:
	.byte 0xAC, 0x38, 0x1C, 0x02
_021BE208:
	.byte 0xCC, 0x38, 0x1C, 0x02
_021BE20C:
	.byte 0x2C, 0x39, 0x1C, 0x02
_021BE210:
	.byte 0x4C, 0x39, 0x1C, 0x02
_021BE214:
...
_021BE460:
	.byte 0x32, 0x00, 0x38, 0x00, 0x30, 0x00, 0x34, 0x00, 0x0C, 0x00, 0x18, 0x00, 0x24, 0x00
_021BE46E:
	cmp r5, #2
	bne _021BE476
	mov r4, #4
...
_021BEAE8:
	.byte 0x28, 0x13, 0x00, 0x00, 0x70, 0xB5, 0x05, 0x1C
...
_021BF61E:
	.byte 0x06, 0x00
	.byte 0x0A, 0x00, 0x7A, 0x00, 0x48, 0x00
_021BF626:
	add r0, r7, #0
	pop {r3, r4, r5, r6, r7, pc}
_021BF62A:
...
_021BF870:
	...
	add pc, r0
_021BF882:
	.byte 0x06, 0x00, 0x0A, 0x00, 0x74, 0x00, 0x48, 0x00
_021BF88A:
	add r0, r5, #0
	pop {r3, r4, r5, r6, r7, pc}
_021BF88E:
...
_021C07E6:
	...
	add pc, r0
_021C07F6:
	.byte 0x0A, 0x00, 0x0C, 0x00, 0x20, 0x00, 0x40, 0x00, 0x38, 0x00
	.byte 0x3E, 0x00
_021C0802:
	b _021C0838
_021C0804:
...
_021C08B8:
	.byte 0x28, 0x00, 0x0A, 0x00, 0x14, 0x00, 0x28, 0x00
	.byte 0x28, 0x00, 0x14, 0x00
caseD_:
	add r0, r4, #0
