...
_021B6144:
	.byte 0x24, 0x75, 0x1B, 0x02, 0x00, 0x4B, 0x18, 0x47
_021B614C:
...
_021B6758:
	.byte 0x24, 0x75, 0x1B, 0x02
_021B675C:
	.byte 0x1C, 0x74, 0x1B, 0x02
...
_021B69C0:
	.byte 0x4D, 0x6A, 0x1B, 0x02, 0x38, 0xB5
_021B69C6:
...
_021B6AD0:
	.byte 0xA9, 0x6B, 0x1B, 0x02
_021B6AD4:
	.byte 0x61, 0x6A, 0x1B, 0x02, 0x38, 0xB5
_021B6ADA:
	.byte 0x0C, 0x1C, 0x21, 0x88, 0x03, 0x1C
	.byte 0x06, 0x29, 0x5D, 0xD8, 0x49, 0x18, 0x79, 0x44, 0xC9, 0x88, 0x09, 0x04, 0x09, 0x14, 0x8F, 0x44

	arm_func_start switchdataD_overlay_d_101__021b6af0
switchdataD_overlay_d_101__021b6af0: ; 0x021B6AF0
	andeqs r0, ip, ip
	subeqs r0, r8, r0, lsr r0
	addeqs r0, r4, ip, rrx
	smlatbhs r0, r8, r0, r0
	arm_func_end switchdataD_overlay_d_101__021b6af0
_021B6B00:
...
_021B6C36: ; jump table
	.hword _021B6C3E - _021B6C36 - 2 ; case 0
	.hword _021B6C5A - _021B6C36 - 2 ; case 1
	.hword _021B6C70 - _021B6C36 - 2 ; case 2
	.hword _021B6C84 - _021B6C36 - 2 ; case 3
_021B6C3E:
...
_021B6C8C:
	...
	pop {r3, r4, r5, pc}
_021B6C90:
	.byte 0xC0, 0x74, 0x1B, 0x02
_021B6C94:
	.byte 0xB8, 0x74, 0x1B, 0x02
_021B6C98:
	.byte 0xBC, 0x74, 0x1B, 0x02
_021B6C9C:
	.byte 0xC4, 0x74, 0x1B, 0x02
...
_021B74C4:
	...
	.byte 0x8D, 0x6E, 0x1B, 0x02, 0xBD, 0x6E, 0x1B, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
_021B7520:
