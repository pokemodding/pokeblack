...
_021B7732:
	...
	arm_func_start switchdataD_overlay_d_105__021b7790
switchdataD_overlay_d_105__021b7790: ; 0x021B7790
	andeqs r0, r2, ip
	eoreq r0, lr, r2, lsr #32
	subeqs r0, r8, r8, asr #32
	andhs r0, r1, r4, rrx
	arm_func_end switchdataD_overlay_d_105__021b7790
...
_021B7912:
	...
	nop
_021B7A2C:
	.byte 0x64, 0x89, 0x1B, 0x02
_021B7A30:
	.byte 0xB8, 0x89, 0x1B, 0x02
_021B7A34:
	.byte 0x08, 0x8A, 0x1B, 0x02
_021B7A38:
	.byte 0x98, 0x89, 0x1B, 0x02
...
_021B80E4:
	...
	.byte 0x87, 0x44, 0x14, 0x00, 0x2C, 0x00, 0x3A, 0x00, 0x70, 0x00, 0x9E, 0x00, 0xDC, 0x00, 0x2C, 0x01
...
_021B820E: ; jump table
	.hword _021B8224 - _021B820E - 2 ; case 0
	.hword _021B8222 - _021B820E - 2 ; case 1
	.hword _021B8222 - _021B820E - 2 ; case 2
	.hword _021B8222 - _021B820E - 2 ; case 3
	.hword _021B821E - _021B820E - 2 ; case 4
	.hword _021B821A - _021B820E - 2 ; case 5
_021B821A:
...
_021B8706:
	...
	nop
_021B870C:
	.byte 0x86, 0x89, 0x1B, 0x02
_021B8710:
	.byte 0x84, 0x89, 0x1B, 0x02
_021B8714:
	.byte 0xFF, 0x7F, 0x00, 0x00
_021B8718:
	.byte 0xCE, 0x07, 0x00, 0x00
...
_021B894E:
	...
	pop {r3, r4, r5, r6, r7, pc}
_021B8954:
	.byte 0xE7, 0x03, 0x00, 0x00, 0x61, 0x75, 0x1B, 0x02, 0x79, 0x77, 0x1B, 0x02
...
_021B897C:
	...
	thumb_func_start DAT_overlay_d_105__021b898
DAT_overlay_d_105__021b898: ; 0x021B8980
	lsl r0, r5, #0xf
	.balign 4, 0
	thumb_func_end DAT_overlay_d_105__021b898

	thumb_func_start DAT_overlay_d_105__021b8985
DAT_overlay_d_105__021b8985: ; 0x021B8984
	lsl r0, r0, #0
	thumb_func_end DAT_overlay_d_105__021b8985
_021B8986:
