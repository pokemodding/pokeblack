...
_021E546E:
	...
	pop {r4, r5, r6, pc}
_021E54C8:
	.byte 0x3C, 0xFC, 0xFF, 0x02, 0xF8, 0xB5
_021E54CE:
	.byte 0x07, 0x1C
...
_021E5520:
	.byte 0x5A, 0x00, 0x00, 0x00, 0x70, 0xB5, 0x1C, 0x1C, 0x20, 0x1C, 0x98, 0x30, 0x00, 0x68, 0x15, 0x1C
...
_021E55AA:
	...
	add pc, r0
_021E55C4:
	.byte 0x2A, 0x00, 0x1A, 0x00, 0x1A, 0x00, 0x2A, 0x00, 0x08, 0x00
_021E55CE:
	mov r0, #3
	str r0, [r5, #0x20]
	add r0, r4, #0
...
_021E55F0:
	...
	add pc, r0
_021E5602:
	.byte 0x0A, 0x00, 0x2A, 0x00, 0x3C, 0x00, 0x58, 0x00, 0x76, 0x00, 0xA4, 0x00
_021E560E:
...
_021E5734:
	.byte 0x08, 0x00, 0x0E, 0x00, 0x10, 0x00, 0x12, 0x00, 0x16, 0x00
_021E573E:
	str r7, [r4, #0x38]
	mov r0, #1
	b _021E5750
...
_021E591E:
	.byte 0x16, 0x00
	.byte 0x08, 0x00, 0x10, 0x00, 0x10, 0x00, 0x08, 0x00
_021E5928:
	mov r0, #3
	str r0, [r6, #8]
	add r0, r7, #0
...
_021E5936:
	...
	add pc, r0
_021E5948:
	.byte 0x16, 0x00, 0x2A, 0x00, 0x3C, 0x00, 0x60, 0x00
	.byte 0x68, 0x00, 0x7A, 0x00, 0x88, 0x00, 0x96, 0x00, 0x9E, 0x00, 0xB0, 0x00, 0xCE, 0x00, 0xD6, 0x00
_021E5960:
	blx FUN_020399A8
	mov r1, #0x10
_021E5966:
...
_021E5ABE:
	.byte 0x0A, 0x00
	.byte 0x0C, 0x00, 0x20, 0x00, 0x32, 0x00, 0x40, 0x00, 0x4E, 0x00
_021E5ACA:
	b _021E5ADA
_021E5ACC:
	blx FUN_020399A8
...
_021E5B2C:
	...
	.byte 0xBD, 0x58, 0x1E, 0x02, 0x89, 0x58, 0x1E, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
