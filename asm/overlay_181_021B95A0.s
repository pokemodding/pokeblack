...
_021B95D0:
	.byte 0x00, 0x50, 0x12, 0x00, 0x08, 0xB5
_021B95D6:
...
_021B984E:
	...
	add pc, r0
_021B9864:
	.byte 0x78, 0x00, 0x0A, 0x00, 0x42, 0x00, 0x52, 0x00, 0x78, 0x00, 0x5E, 0x00
_021B9870:
	add r0, r5, #0
	sub r0, #0x12
	ldrsh r0, [r4, r0]
...
_021B98A8:
	add r0, r4, #0
	bl FUN_overlay_d_181__021ba5e8
	cmp r0, #0
	bne _021B98DE
_021B98B2:
	mov r0, #0
...
_021B98B8:
	add r0, r4, #0
	bl FUN_overlay_d_181__021ba6f0
	cmp r0, #0
	bne _021B98DE
	b _021B98B2
_021B98C4:
...
_021B99BC:
	.byte 0x74, 0xAC, 0x1B, 0x02
_021B99C0:
	.byte 0xC4, 0xAC, 0x1B, 0x02
_021B99C4:
	.byte 0x84, 0xAC, 0x1B, 0x02
_021B99C8:
	.byte 0xA4, 0xAC, 0x1B, 0x02
...
_021B9AB8:
	...
	nop
_021B9AD0:
	.byte 0x8E, 0x80, 0x00, 0x00, 0x08, 0xB5
_021B9AD6:
...
_021B9E6E:
	...
	pop {r3, r4, r5, r6, pc}
_021B9EF8:
	.byte 0x50, 0xAB, 0x1B, 0x02
_021B9EFC:
	.byte 0x38, 0xAB, 0x1B, 0x02
_021B9F00:
	.byte 0x68, 0xAC, 0x1B, 0x02
_021B9F04:
	.byte 0xE4, 0xAC, 0x1B, 0x02
_021B9F08:
	.byte 0xB8, 0x1E, 0x0A, 0x02
_021B9F0C:
	.byte 0xF0, 0xAC, 0x1B, 0x02
_021B9F10:
...
_021BA84C:
	...
	add pc, r1
_021BA858:
	.byte 0x06, 0x00, 0x46, 0x00, 0xBE, 0x00, 0xF6, 0x00
_021BA860:
	mov r1, #1
...
_021BAA4C:
	.byte 0xFF, 0xFF, 0x00, 0x00
_021BAA50:
	.byte 0xDA, 0x02, 0x00, 0x00, 0x10, 0xB5
_021BAA56:
...
_021BACF0:
	...
	.byte 0x1A, 0xA4, 0x0E, 0x00, 0xEA, 0x5B, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
