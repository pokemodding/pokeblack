...
_0220B304:
	...
	blx FUN_02045334
_0220B30A:
	ldr r1, _0220B314 ; =DAT_overlay_d_197__0220da0d
...
_0220B540:
	...
	b _0220B560
_0220B55E:
	ldr r1, _0220B57C ; =DAT_overlay_d_197__0220da19
_0220B560:
...
FUN_overlay_d_197__0220b6c4: ; 0x0220B6C4
	...
	arm_func_start switchdataD_overlay_d_197__0220b6f4
switchdataD_overlay_d_197__0220b6f4: ; 0x0220B6F4
	eoreq r0, r8, r6
	subeqs r0, lr, sl, asr #32
	arm_func_end switchdataD_overlay_d_197__0220b6f4

	thumb_func_start FUN_0220B6FC
FUN_0220B6FC: ; 0x0220B6FC
	mov r5, #0xf1
	lsl r5, r5, #6
	add r0, r4, #0
	mov r1, #0x1d
...
_0220BA82:
	...
	tst r0, r1
	beq _0220BAB2
	ldr r0, _0220BB14 ; =DAT_overlay_d_197__0220db3f
	mov r4, #0x90
	ldrb r0, [r0, r3]
	ldrh r5, [r2]
	add r1, r6, r0
...
_0220CC36:
	...
	arm_func_start switchdataD_overlay_d_197__0220cc68
switchdataD_overlay_d_197__0220cc68: ; 0x0220CC68
	eoreqs r0, r0, r0, lsr r0
	eoreqs r0, r0, r0, lsr r0
	addeq r0, sl, r4, asr r0
	arm_func_end switchdataD_overlay_d_197__0220cc68

	thumb_func_start FUN_0220CC74
FUN_0220CC74: ; 0x0220CC74
	mov r0, #6
	mvn r0, r0
	b _0220CC96
	thumb_func_end FUN_0220CC74
_0220CC7A:
	add r1, r0, #2
	cmp r5, r1
	bhi _0220CC86
...
_0220CD84:
	...
	arm_func_start switchdataD_overlay_d_197__0220cda0
switchdataD_overlay_d_197__0220cda0: ; 0x0220CDA0
	subeq r0, sl, sl, asr #32
	subeq r0, sl, sl, asr #32
	subeq r0, sl, sl, asr #32
	rsceqs r0, sl, sl, lsl #1
	arm_func_end switchdataD_overlay_d_197__0220cda0
_0220CDB0:
	.byte 0x36, 0x01

	non_word_aligned_thumb_func_start FUN_0220CDB2
FUN_0220CDB2: ; 0x0220CDB2
	mov r0, #6
	mvn r0, r0
	cmp r5, r0
	bhi _0220CDBC
	b _0220CDE8
	thumb_func_end FUN_0220CDB2
_0220CDBC:
	add r0, r0, #1
	cmp r5, r0
	bne _0220CDC4
...
_0220D056:
	...
	arm_func_start switchdataD_overlay_d_197__0220d068
switchdataD_overlay_d_197__0220d068: ; 0x0220D068
	adceq r0, r0, r0, lsr #1
	addeqs r0, r8, r0, lsr #1
	arm_func_end switchdataD_overlay_d_197__0220d068
_0220D070:
	.byte 0x98, 0x00, 0x7C, 0x00, 0xA0, 0x00

	non_word_aligned_thumb_func_start FUN_0220D076
FUN_0220D076: ; 0x0220D076
...
_0220D466:
	...
	arm_func_start switchdataD_overlay_d_197__0220d47c
switchdataD_overlay_d_197__0220d47c: ; 0x0220D47C
	subeq r0, r4, sl
	adceq r0, sl, r8, rrx
	smlawteq r2, lr, r0, r0
	addeq r2, r0, r3, asr r0
	arm_func_end switchdataD_overlay_d_197__0220d47c
_0220D48C:
	.byte 0x20, 0x58, 0xFC, 0xF7
...
_0220DA08:
	...
	thumb_func_start DAT_overlay_d_197__0220da0d
DAT_overlay_d_197__0220da0d: ; 0x0220DA0C
	lsl r7, r7, #3
	lsl r1, r0, #8
	lsl r3, r0, #0x10
	lsl r7, r7, #0x13
	asr r1, r0, #0xc
	lsl r6, r3, #0x10
	thumb_func_end DAT_overlay_d_197__0220da0d

	thumb_func_start DAT_overlay_d_197__0220da19
DAT_overlay_d_197__0220da19: ; 0x0220DA18
	asr r4, r1, #4
	asr r2, r2, #0xc
	asr r4, r2, #0x14
	asr r6, r2, #0x1c
	...
	sub r2, r3, r4
	add r4, r3, #4
	thumb_func_end DAT_overlay_d_197__0220da19
_0220DA26:
	.byte 0x1E, 0xFF
_0220DA28:
...
_0220DA68:
	...
	non_word_aligned_thumb_func_start DAT_overlay_d_197__0220da6b
DAT_overlay_d_197__0220da6b: ; 0x0220DA6A
	lsr r4, r0, #0x10
	thumb_func_end DAT_overlay_d_197__0220da6b

	thumb_func_start DAT_overlay_d_197__0220da6d
DAT_overlay_d_197__0220da6d: ; 0x0220DA6C
	lsr r4, r0, #0x10
	thumb_func_end DAT_overlay_d_197__0220da6d

	non_word_aligned_thumb_func_start DAT_overlay_d_197__0220da6f
DAT_overlay_d_197__0220da6f: ; 0x0220DA6E
	lsl r4, r0, #8
	thumb_func_end DAT_overlay_d_197__0220da6f
_0220DA70:
	.byte 0x0D, 0x0C

	non_word_aligned_thumb_func_start DAT_overlay_d_197__0220da73
DAT_overlay_d_197__0220da73: ; 0x0220DA72
	lsr r4, r0, #0x10
	asr r4, r0, #8
	lsr r5, r0, #0x10
	lsr r2, r0, #0x10
	...
	lsr r2, r0, #0x10
	lsl r0, r0, #0
	thumb_func_end DAT_overlay_d_197__0220da73
_0220DB3C:
	.byte 0x00, 0x01

	non_word_aligned_thumb_func_start DAT_overlay_d_197__0220db3f
DAT_overlay_d_197__0220db3f: ; 0x0220DB3E
	lsl r3, r0, #8
	lsl r3, r0, #0
	lsl r1, r0, #0
	thumb_func_end DAT_overlay_d_197__0220db3f
_0220DB44:
	.byte 0x04, 0x00

	non_word_aligned_thumb_func_start DAT_overlay_d_197__0220db47
DAT_overlay_d_197__0220db47: ; 0x0220DB46
	lsr r0, r2, #0x20
	lsl r5, r0, #0
	thumb_func_end DAT_overlay_d_197__0220db47
_0220DB4A:
...
_0220DF3C:
	.byte 0x00, 0x00, 0x00, 0x00
	.byte 0x81, 0xC9, 0x20, 0x02, 0xAD, 0xCA, 0x20, 0x02, 0xB5, 0xCB
_0220DF4A:
	lsl r0, r4, #8
	ldmia r3!, {r0, r3, r5, r6, r7}
	lsl r0, r4, #8
	ldmia r4!, {r0, r3, r4}
	lsl r0, r4, #8
	ldmia r5!, {r0, r4, r6}
...
_0220DF9C:
	...
	.byte 0x50, 0xE0, 0x20, 0x02, 0xD8, 0xDF
_0220DFA6:
	lsl r0, r4, #8

	arm_func_start PTR_FUN_overlay_d_197__0220d9a8_1_overlay_d_197__0220dfa8
PTR_FUN_overlay_d_197__0220d9a8_1_overlay_d_197__0220dfa8: ; 0x0220DFA8
	eoreq sp, r0, #0x2a4000
	eoreq sp, r0, #0x2f4000
	eoreq sp, r0, #0x354000
	eoreq sp, r0, #0x324000
	arm_func_end PTR_FUN_overlay_d_197__0220d9a8_1_overlay_d_197__0220dfa8
_0220DFB8:
	.byte 0xDD, 0xD9, 0x20, 0x02, 0xBD, 0xD9, 0x20, 0x02
	.byte 0xD5, 0xD9, 0x20, 0x02, 0xC9, 0xD9, 0x20, 0x02

	arm_func_start PTR_FUN_overlay_d_197__0220d9a8_1_overlay_d_197__0220dfc8
PTR_FUN_overlay_d_197__0220d9a8_1_overlay_d_197__0220dfc8: ; 0x0220DFC8
	eoreq sp, r0, #0x2a4000
	arm_func_end PTR_FUN_overlay_d_197__0220d9a8_1_overlay_d_197__0220dfc8
_0220DFCC:
	.byte 0xBD, 0xD9

	non_word_aligned_thumb_func_start FUN_0220DFCE
FUN_0220DFCE: ; 0x0220DFCE
	lsl r0, r4, #8
	bls _0220DF7E
_0220DFD2:
	lsl r0, r4, #8
...
_0220E01E:
	...
	.byte 0x01, 0x04, 0x04, 0x05, 0x98, 0xBF
_0220E036:
	ldmia r7!, {r3}
	add r6, sp, #0x3c0
	cmp r4, #0x34
...
_0220E056:
	...
	add r7, #8
_0220E066:
	.byte 0x80, 0xFF, 0x40, 0x50, 0x84, 0x36, 0x00, 0x04
_0220E06E:
	lsl r2, r0, #0xc
	str r0, [r7, #0x70]
	ldrb r0, [r0, #0x1c]
