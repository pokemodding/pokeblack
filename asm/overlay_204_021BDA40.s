	...
	thumb_func_start FUN_overlay_204__021bda40
FUN_overlay_204__021bda40: ; 0x021BDA40
	push {r4, r5, r6, lr}
	thumb_func_end FUN_overlay_204__021bda40
...
_021BDBE4:
	...
	pop {r3, r4, r5, pc}
	.balign 4, 0
_021BDC00: .word 0x04000008
_021BDC04: .word 0xFFFFCFFD
_021BDC08: .word 0x0000CFEF
_021BDC0C: .word 0xBFFF0000
_021BDC10: .word 0x04000580
_021BDC14: .word 0x021BFDAC
...
FUN_overlay_d_204__021bdc18: ; 0x021BDC18
	...
	cmp r6, #7
	bne _021BDC98
	ldr r0, _021BDCE4 ; =_021BFE4C
	blx FUN_020433E0
	add r0, r4, #0
	add r1, r5, #0
	bl FUN_overlay_d_204__021bde30
	ldr r1, _021BDCE8 ; =_021BFE1C
	add r0, r4, #4
	add r2, r5, #0
...
_021BDCBC:
	...
	.balign 4, 0
_021BDCD0: .word 0x00000196
_021BDCD4: .word 0x021C09C0
_021BDCD8: .word 0x04000050
_021BDCDC: .word 0x04001050
_021BDCE0: .word 0xFFFF1FFF
_021BDCE4: .word 0x021BFE4C
_021BDCE8: .word 0x021BFE1C
_021BDCEC: .word 0x021BDD85
...
_021BDD40: .word 0x04000050
_021BDD44: .word 0x04001050
_021BDD48: .word 0xFFFF1FFF
...
FUN_overlay_d_204__021bdd98: ; 0x021BDD98
	...
	add r0, r5, #0
	blx FUN_02045088
	ldr r0, _021BDDF0 ; =_021BFD80
	blx FUN_0203FC28
	ldr r7, _021BDDF4 ; =_021BFF1C
...
_021BDDBA:
	...
	pop {r3, r4, r5, r6, r7, pc}
	.balign 4, 0
_021BDDF0: .word 0x021BFD80
_021BDDF4: .word 0x021BFF1C
...
FUN_overlay_d_204__021bde30: ; 0x021BDE30
	...
	add r0, r4, #0
	blx FUN_02045088
	ldr r0, _021BDF1C ; =_021BFD80
	blx FUN_0203FC28
	ldr r4, _021BDF20 ; =_021BFEFC
	add r3, sp, #0x80
	add r2, r3, #0
	ldmia r4!, {r0, r1}
	stmia r3!, {r0, r1}
...
_021BDF1C: .word 0x021BFD80
_021BDF20: .word 0x021BFEFC
_021BDF24: .word 0x021BFEDC
_021BDF28: .word 0x021BFE7C
_021BDF2C: .word 0x021BFE9C
_021BDF30: .word 0x021BFEBC
...
FUN_overlay_d_204__021bdfa4: ; 0x021BDFA4
	...
	lsl r0, r6, #0x15
	str r0, [sp, #8]
	ldr r0, _021BE020 ; =_021BFD68
	str r7, [sp, #0xc]
	str r0, [sp, #0x10]
	ldr r0, _021BE024 ; =_021BFD5C
	ldr r2, _021BE028 ; =0x020A1EB8
	str r0, [sp, #0x14]
	ldr r0, _021BE02C ; =_021BFD74
	mov r1, #0xc
	str r0, [sp, #0x18]
	mov r3, #0xe
	ldrsh r1, [r2, r1]
...
_021BE01C: .word 0x021BDB71
_021BE020: .word 0x021BFD68
_021BE024: .word 0x021BFD5C
_021BE028: .word 0x020A1EB8
_021BE02C: .word 0x021BFD74
_021BE030: .word 0x00001555
_021BE034: .word 0x0000019A
_021BE038: .word 0x021BFD4C
...
FUN_overlay_d_204__021be03c: ; 0x021BE03C
	...
	lsl r0, r6, #0x15
	str r0, [sp, #8]
	ldr r0, _021BE0B8 ; =_021BFD68
	str r7, [sp, #0xc]
	str r0, [sp, #0x10]
	ldr r0, _021BE0BC ; =_021BFD5C
	ldr r2, _021BE0C0 ; =0x020A1EB8
	str r0, [sp, #0x14]
	ldr r0, _021BE0C4 ; =_021BFD74
	mov r1, #0xc
	str r0, [sp, #0x18]
	mov r3, #0xe
	ldrsh r1, [r2, r1]
...
_021BE0B4: .word 0x021BDB71
_021BE0B8: .word 0x021BFD68
_021BE0BC: .word 0x021BFD5C
_021BE0C0: .word 0x020A1EB8
_021BE0C4: .word 0x021BFD74
_021BE0C8: .word 0x00001555
_021BE0CC: .word 0x0000019A
_021BE0D0: .word 0x021BFD54
...
_021BE82A:
	...
	pop {r3, r4, r5, pc}
	nop
_021BE830: .word 0xFFFF4800
_021BE834: .word 0x000007F5
_021BE838:
	.byte 0x38, 0xB5
_021BE83A:
...
_021BE964:
	...
	pop {r3, r4, r5, pc}
	.balign 4, 0
_021BE968: .word 0x00000548
_021BE96C: .word 0x0000054D
_021BE970:
	.byte 0x08, 0xB5
_021BE972:
...
_021BED1C:
	...
	pop {r3, r4, r5, r6, r7, pc}
	nop
_021BED60: .word 0x000010B4
_021BED64: .word 0x000010B8
_021BED68: .word 0x021BFFCC
_021BED6C:
	.byte 0xF8, 0xB5
_021BED6E:
	.byte 0x82, 0xB0
...
_021BEE48:
	...
	pop {r3, r4, r5, r6, r7, pc}
	nop
_021BEE50: .word 0x04000050
_021BEE54: .word 0x000010A8
_021BEE58: .word 0x04000052
_021BEE5C:
	.byte 0xF8, 0xB5
_021BEE5E:
	.byte 0x82, 0xB0
...
_021BEEDE:
	...
	pop {r3, r4, r5, r6, r7, pc}
	.balign 4, 0
_021BEEE4: .word 0x04000050
_021BEEE8: .word 0x000010A8
_021BEEEC: .word 0x04000052
_021BEEF0:
...
_021BEF68: .word 0x000006F2
_021BEF6C: .word 0x000010D8
_021BEF70: .word 0x021C0AAC
...
FUN_overlay_d_204__021bf094: ; 0x021BF094
	lsl r1, r0, #2
	ldr r0, _021BF09C ; =_021C0AB8
	ldr r0, [r0, r1]
	bx lr
	.balign 4, 0
	thumb_func_end FUN_overlay_d_204__021bf094
_021BF09C: .word 0x021C0AB8
...
_021BF4CC:
	...
	pop {r4, r5, r6, r7, pc}
	nop
_021BF4DC: .word 0xFFFFFE7F
_021BF4E0: .word 0xFFFF81FF
_021BF4E4: .word 0xFFFF7FFF
...
_021BF674: .word 0x021C08F0
_021BF678: .word 0x021BF7F1
...
_021BF718: .word 0x021C08FC
_021BF71C: .word 0x021BF7F1
...
FUN_overlay_d_204__021bf8dc: ; 0x021BF8DC
	...
	blx FUN_02047CFC
	add r2, sp, #0x3c
	ldr r3, _021BF9B8 ; =_021C0914
	str r0, [r4, #8]
	ldmia r3!, {r0, r1}
	add r7, r2, #0
	stmia r2!, {r0, r1}
	ldr r0, [r3]
	ldr r3, _021BF9BC ; =_021C0920
	str r0, [r2]
	add r2, sp, #0x30
	ldmia r3!, {r0, r1}
	mov ip, r2
...
_021BF9AA:
	...
	pop {r3, r4, r5, r6, r7, pc}
	.balign 4, 0
_021BF9B4: .word 0x021C0B00
_021BF9B8: .word 0x021C0914
_021BF9BC: .word 0x021C0920
_021BF9C0: .word 0x021C0908
_021BF9C4: .word 0xFFFF8000
_021BF9C8: .word 0xFFFFA000
_021BF9CC: .word 0x021C093C
...
_021BFAD6:
	...
	pop {r3, r4, r5, r6, r7, pc}
	nop
_021BFADC: .word 0x04000050
_021BFAE0: .word 0x00000555
...
FUN_overlay_d_204__021bfc24: ; 0x021BFC24
	...
	ldr r0, [r4, #8]
	blx FUN_02051758
	ldr r0, _021BFCC4 ; =_021C0B0C
	ldr r3, _021BFCC8 ; =_021C0B18
	str r0, [sp]
	ldr r0, _021BFCCC ; =_021C0B24
	add r1, sp, #0xc
	str r0, [sp, #4]
	ldrh r0, [r4]
	lsl r2, r5, #0xc
...
_021BFCB4: .word 0x0000480C
_021BFCB8: .word 0x021C0B30
_021BFCBC: .word 0xFFFFC000
_021BFCC0: .word 0xFFFFD000
_021BFCC4: .word 0x021C0B0C
_021BFCC8: .word 0x021C0B18
_021BFCCC: .word 0x021C0B24
...
_021C093C:
	...
	.section .data, 4
	.global overlay_204_021BDA40_data
overlay_204_021BDA40_data:
_021C09C0:
...
_021C0AAC:
	.byte 0x69, 0x6E, 0x74, 0x72
	.byte 0x6F, 0x5F, 0x63, 0x6D, 0x64, 0x2E, 0x63, 0x00
_021C0AB8:
...
_021C0AE4:
	.byte 0x69, 0x6E, 0x74, 0x72, 0x6F, 0x5F, 0x6D, 0x73, 0x67, 0x2E, 0x63, 0x00
_021C0AF0:
	.byte 0x69, 0x6E, 0x74, 0x72, 0x6F, 0x5F, 0x6D, 0x63, 0x73, 0x73, 0x2E, 0x63, 0x00, 0x00, 0x00, 0x00
_021C0B00:
	.byte 0x69, 0x6E, 0x74, 0x72, 0x6F, 0x5F, 0x67, 0x33, 0x64, 0x2E, 0x63, 0x00
_021C0B0C:
	.byte 0x00, 0x00, 0x00, 0x00
