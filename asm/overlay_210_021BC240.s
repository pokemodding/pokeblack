...
_021BC2B4:
	.byte 0xAC, 0x0E, 0x03, 0x02, 0x70, 0xB5, 0x0D, 0x1C, 0x85, 0xF6, 0x92, 0xEB
...
_021BC338:
	.byte 0xAC, 0x0E, 0x03, 0x02, 0x1C, 0x48
_021BC33E:
	.byte 0x02, 0x88
...
_021BC3C0:
	.byte 0x0A, 0x06, 0x00, 0x00
_021BC3C4:
	.byte 0x09, 0x07, 0x00, 0x00
_021BC3C8:
...
_021BC554:
	.byte 0x84, 0x07, 0x1C, 0x02
_021BC558:
	.byte 0x14, 0x08, 0x1C, 0x02
_021BC55C:
	.byte 0xF4, 0x07, 0x1C, 0x02
_021BC560:
	.byte 0x54, 0x08, 0x1C, 0x02
_021BC564:
	.byte 0x74, 0x08, 0x1C, 0x02
_021BC568:
	.byte 0x34, 0x08, 0x1C, 0x02
_021BC56C:
	.byte 0xD4, 0x07, 0x1C, 0x02
_021BC570:
	.byte 0xB4, 0x07, 0x1C, 0x02
_021BC574:
	.byte 0x94, 0x07, 0x1C, 0x02
...
_021BC8AC:
	.byte 0xEF, 0x7F, 0x00, 0x00
_021BC8B0:
	.byte 0x1F, 0xFE, 0x00, 0x00
...
_021BCF68:
	...
	nop
_021BCF88:
	.byte 0x94, 0x08, 0x1C, 0x02, 0xF8, 0xB5
_021BCF8E:
	.byte 0x05, 0x1C
...
_021BD05C:
	.byte 0x50, 0x10, 0x00, 0x04
_021BD060:
	.byte 0xB9, 0x02, 0x00, 0x00, 0x70, 0xB5, 0x04, 0x1C, 0xFF, 0xF7, 0xF6, 0xFE, 0x01, 0x28, 0x04, 0xD0
...
_021BD1C8:
	...
	add pc, r1
_021BD1D8:
	.byte 0x2A, 0x00, 0x46, 0x00, 0x62, 0x00, 0x7E, 0x00
	.byte 0x9A, 0x00, 0xB6, 0x00, 0xCA, 0x00, 0xDE, 0x00, 0xEC, 0x00, 0x10, 0x01
_021BD1EC:
	mov r1, #2
	mvn r1, r1
	cmp r0, r1
...
_021BD368:
	.byte 0x48, 0x05, 0x00, 0x00, 0x10, 0xB5, 0x04, 0x1C
...
_021BD490:
	...
	nop
_021BD498:
	.byte 0xBB, 0x02, 0x00, 0x00
_021BD49C:
	.byte 0x3F, 0x06, 0x00, 0x00
_021BD4A0:
	.byte 0x7B, 0x80, 0x00, 0x00
_021BD4A4:
	.byte 0x6F, 0x07, 0x00, 0x00
_021BD4A8:
	.byte 0x57, 0x05, 0x00, 0x00, 0x10, 0xB5, 0x04, 0x1C
...
_021BD5C8:
	.byte 0x12, 0x00, 0x5C, 0x00, 0x5C, 0x00, 0x5C, 0x00
	.byte 0x5C, 0x00, 0x5C, 0x00, 0x5C, 0x00, 0x6A, 0x00, 0x30, 0x00, 0x4E, 0x00
_021BD5DC:
...
_021BD74A:
	...
	add pc, r0
_021BD75C:
	.byte 0x44, 0x00, 0x4E, 0x00
	.byte 0x66, 0x00, 0x7E, 0x00, 0x7E, 0x00, 0x9C, 0x00, 0x77, 0xF6, 0x2C, 0xEF, 0x00, 0x28, 0x00, 0xD0
_021BD770:
	b _021BD886
_021BD772:
...
_021BD7FA:
	...
	add pc, r0
_021BD812:
	.byte 0x12, 0x00, 0x5C, 0x00, 0x5C, 0x00, 0x5C, 0x00, 0x5C, 0x00, 0x5C, 0x00, 0x5C, 0x00
	.byte 0x5C, 0x00, 0x30, 0x00, 0x4E, 0x00
_021BD826:
...
_021BD890:
	.byte 0x4C, 0x05, 0x00, 0x00
_021BD894:
	.byte 0x51, 0x05, 0x00, 0x00, 0x10, 0xB5, 0x04, 0x1C, 0xFF, 0xF7, 0x4E, 0xFA
...
_021BD9A6:
	...
	add pc, r0
_021BD9B8:
	.byte 0x44, 0x00, 0x4E, 0x00, 0x66, 0x00, 0x7E, 0x00
	.byte 0x7E, 0x00, 0xC4, 0x00, 0x77, 0xF6, 0xFE, 0xED, 0x00, 0x28, 0x00, 0xD0
_021BD9CC:
	b _021BDB0A
_021BD9CE:
...
_021BDA7E:
	...
	add pc, r0
_021BDA96:
	.byte 0x12, 0x00, 0x5C, 0x00, 0x5C, 0x00, 0x5C, 0x00, 0x5C, 0x00
	.byte 0x5C, 0x00, 0x5C, 0x00, 0x5C, 0x00, 0x30, 0x00, 0x4E, 0x00
_021BDAAA:
...
_021BDB14:
	.byte 0x4C, 0x05, 0x00, 0x00
_021BDB18:
	.byte 0x51, 0x05, 0x00, 0x00, 0x10, 0xB5, 0x04, 0x1C
...
_021BDC3C:
	.byte 0x44, 0x00, 0x4E, 0x00
	.byte 0x66, 0x00, 0x7E, 0x00, 0x7E, 0x00, 0x9C, 0x00, 0x77, 0xF6, 0xBC, 0xEC, 0x00, 0x28, 0x00, 0xD0
_021BDC50:
	b _021BDD66
_021BDC52:
...
_021BDD70:
	.byte 0x4C, 0x05, 0x00, 0x00
_021BDD74:
	.byte 0x51, 0x05, 0x00, 0x00, 0x10, 0xB5, 0x04, 0x1C, 0xFE, 0xF7, 0xDE, 0xFF
...
_021BDE54:
	...
	add pc, r0
_021BDE68:
	.byte 0x26, 0x00, 0x26, 0x00, 0x30, 0x00, 0x4A, 0x00
	.byte 0x54, 0x00, 0x6C, 0x00, 0x84, 0x00, 0x84, 0x00, 0xA0, 0x00, 0x77, 0xF6, 0xA4, 0xEB, 0x00, 0x28
	.byte 0x00, 0xD0
_021BDE82:
	b _021BDF96
_021BDE84:
...
_021BDF0A:
	...
	add pc, r0
_021BDF22:
	.byte 0x12, 0x00, 0x5C, 0x00, 0x5C, 0x00, 0x5C, 0x00, 0x5C, 0x00, 0x72, 0x00, 0x72, 0x00
	.byte 0x72, 0x00, 0x30, 0x00, 0x4E, 0x00
_021BDF36:
...
_021BDFA0:
	.byte 0x4C, 0x05, 0x00, 0x00
_021BDFA4:
	.byte 0x51, 0x05, 0x00, 0x00, 0x10, 0xB5, 0x04, 0x1C, 0xFE, 0xF7, 0xC6, 0xFE
...
_021BF260:
	...
	nop
_021BF34C:
	.byte 0xAC, 0x09, 0x1C, 0x02
_021BF350:
	.byte 0x78, 0x09, 0x1C, 0x02
_021BF354:
...
_021BFF00:
	...
	nop
_021BFF10:
	.byte 0x60, 0x0B, 0x1C, 0x02
_021BFF14:
	.byte 0x14, 0x0B, 0x1C, 0x02
