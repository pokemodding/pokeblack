...
_021BC2BA:
	...
	nop
_021BC2D4:
	.byte 0x90, 0xC9, 0x1B, 0x02, 0x08, 0xB5
_021BC2DA:
...
_021BC420:
	.byte 0xC8, 0xC8, 0x1B, 0x02
_021BC424:
	.byte 0x10, 0xC9, 0x1B, 0x02
_021BC428:
	.byte 0x30, 0xC9, 0x1B, 0x02
_021BC42C:
	.byte 0xE0, 0x7F, 0x00, 0x00
_021BC430:
	.byte 0x50, 0xC9, 0x1B, 0x02
_021BC434:
	.byte 0x70, 0xC9, 0x1B, 0x02
_021BC438:
	.byte 0xF0, 0xC8, 0x1B, 0x02
...
_021BC7A0:
	...
	arm_func_start switchdataD_overlay_d_211__021bc7b8
switchdataD_overlay_d_211__021bc7b8: ; 0x021BC7B8
	subeq r0, lr, r6
	adceqs r0, r0, r6, lsl #1
	ldmhsda sl, {r5, r7, sb, fp, ip, sp, lr}
	ldmmida r0!, {r3, r8, ip, lr, pc}
	.word 0xFD0CF649
	arm_func_end switchdataD_overlay_d_211__021bc7b8
