...
_021B9824:
	.byte 0x14, 0xAF, 0x1B, 0x02
_021B9828:
	.byte 0x18, 0xAF, 0x1B, 0x02
_021B982C:
	.byte 0x1C, 0xAF, 0x1B, 0x02
...
_021B9850:
	.byte 0x8C, 0x49, 0x00, 0x00
_021B9854:
	.byte 0xFE, 0xFF, 0x00, 0x00, 0x08, 0xB5, 0x08, 0x1C, 0x00, 0xF0, 0x96, 0xFD
...
_021B9A48:
	...
	nop
_021B9A50:
	.byte 0xC8, 0x49, 0x00, 0x00
_021B9A54:
	.byte 0xD0, 0x49, 0x00, 0x00
_021B9A58:
	.byte 0xA4, 0xB0, 0x1B, 0x02
_021B9A5C:
	.byte 0xEC, 0xB0, 0x1B, 0x02
_021B9A60:
	.byte 0xBC, 0xB0, 0x1B, 0x02
_021B9A64:
	.byte 0xC8, 0xB0, 0x1B, 0x02
...
_021B9AE4:
	...
	pop {r4, r5, r6, pc}
_021B9B08:
	.byte 0xC8, 0x49, 0x00, 0x00, 0xF8, 0xB5, 0x92, 0xB0
...
_021B9E3A: ; jump table
	.hword _021B9E4C - _021B9E3A - 2 ; case 0
	.hword _021B9E44 - _021B9E3A - 2 ; case 1
	.hword _021B9E48 - _021B9E3A - 2 ; case 2
	.hword _021B9E44 - _021B9E3A - 2 ; case 3
	.hword _021B9E48 - _021B9E3A - 2 ; case 4
_021B9E44:
	mov r0, #0
	bx lr
_021B9E48:
...
FUN_overlay_d_213__021b9e50: ; 0x021B9E50
	...
	arm_func_start switchdataD_overlay_d_213__021b9e60
switchdataD_overlay_d_213__021b9e60: ; 0x021B9E60
	andeq r0, r8, r8, lsl r0
	andeqs r0, r0, ip
	arm_func_end switchdataD_overlay_d_213__021b9e60
_021B9E68:
	.byte 0x14, 0x00

	non_word_aligned_thumb_func_start FUN_021B9E6A
FUN_021B9E6A: ; 0x021B9E6A
	mov r0, #1
	bx lr
_021B9E6E:
	mov r0, #1
...
FUN_overlay_d_213__021b9e80: ; 0x021B9E80
	...
	arm_func_start switchdataD_overlay_d_213__021b9e90
switchdataD_overlay_d_213__021b9e90: ; 0x021B9E90
	andeq r0, r8, r8, lsl r0
	andeqs r0, r0, ip
	arm_func_end switchdataD_overlay_d_213__021b9e90
_021B9E98:
	.byte 0x14, 0x00

	non_word_aligned_thumb_func_start FUN_021B9E9A
FUN_021B9E9A: ; 0x021B9E9A
	mov r0, #1
	bx lr
_021B9E9E:
	mov r0, #0
...
_021B9EB8:
	...
	arm_func_start switchdataD_overlay_d_213__021b9ec8
switchdataD_overlay_d_213__021b9ec8: ; 0x021B9EC8
	andeq r0, lr, sl
	andeq r0, r6, r2, lsl r0
	arm_func_end switchdataD_overlay_d_213__021b9ec8

	thumb_func_start FUN_021B9ED0
FUN_021B9ED0: ; 0x021B9ED0
	mov r0, #0xd
	bx lr
_021B9ED4:
	mov r0, #0xa
...
_021B9F58:
	...
	arm_func_start switchdataD_overlay_d_213__021b9f68
switchdataD_overlay_d_213__021b9f68: ; 0x021B9F68
	andeqs r0, r4, r6
	eoreq r0, lr, r2, lsr #32
	arm_func_end switchdataD_overlay_d_213__021b9f68

	thumb_func_start FUN_021B9F70
FUN_021B9F70: ; 0x021B9F70
	lsl r0, r4, #4
	neg r0, r0
	add r0, #0x50
	lsl r0, r0, #0x10
...
_021BA138:
	.byte 0x00, 0xDB, 0xFF, 0xFF
_021BA13C:
	.byte 0x00, 0xE8, 0xFF, 0xFF
_021BA140:
	.byte 0x00, 0xEB, 0xFF, 0xFF
_021BA144:
	.byte 0x00, 0xD8, 0xFF, 0xFF
_021BA148:
	.byte 0x8C, 0xB0, 0x1B, 0x02
...
_021BA16A: ; jump table
	.hword _021BA1AC - _021BA16A - 2 ; case 0
	.hword _021BA174 - _021BA16A - 2 ; case 1
	.hword _021BA190 - _021BA16A - 2 ; case 2
	.hword _021BA178 - _021BA16A - 2 ; case 3
	.hword _021BA194 - _021BA16A - 2 ; case 4
_021BA174:
	mov r1, #0xc
	b _021BA1AC
_021BA178:
...
_021BA22E: ; jump table
	.hword _021BA236 - _021BA22E - 2 ; case 0
	.hword _021BA23C - _021BA22E - 2 ; case 1
	.hword _021BA242 - _021BA22E - 2 ; case 2
	.hword _021BA248 - _021BA22E - 2 ; case 3
_021BA236:
	mov r5, #5
	mov r4, #0xd
	b _021BA24C
...
_021BA3FC:
	.byte 0xC8, 0x49, 0x00, 0x00
_021BA400:
	.byte 0x3C, 0x48, 0x00, 0x00
_021BA404:
	.byte 0xB8, 0x49, 0x00, 0x00
...
_021BA53A:
	.byte 0x3E, 0x00, 0x5C, 0x00, 0x2E, 0x00
	.byte 0x5C, 0x00, 0x5C, 0x00, 0x5C, 0x00, 0x5C, 0x00, 0x5C, 0x00, 0x5C, 0x00, 0x5C, 0x00, 0x4E, 0x00
	.byte 0x4E, 0x00, 0x5C, 0x00, 0x4E, 0x00, 0x4E, 0x00, 0x4E, 0x00, 0x4E, 0x00, 0x5C, 0x00, 0x5C, 0x00
	.byte 0x5C, 0x00, 0x5C, 0x00, 0x2E, 0x00
_021BA566:
	cmp r0, #0x25
	bne _021BA598
_021BA56A:
...
_021BA8B0:
	.byte 0x24, 0xB3, 0x1B, 0x02
_021BA8B4:
	.byte 0x30, 0xB3, 0x1B, 0x02
_021BA8B8:
	.byte 0x60, 0xB3, 0x1B, 0x02
...
_021BAC04:
	.byte 0xC8, 0xB1, 0x1B, 0x02
_021BAC08:
	.byte 0xA1, 0xAC, 0x1B, 0x02
...
_021BACD6:
	...
	pop {r3, r4, r5, r6, r7, pc}
_021BAD0C:
	.byte 0x7C, 0xB1, 0x1B, 0x02
_021BAD10:
	.byte 0xF8, 0xB1, 0x1B, 0x02
...
_021BAE28:
	.byte 0xBD, 0xAA, 0x1B, 0x02
_021BAE2C:
	.byte 0x58, 0xB1, 0x1B, 0x02
_021BAE30:
	.byte 0xB8, 0x1E, 0x0A, 0x02
_021BAE34:
	.byte 0x70, 0xB1, 0x1B, 0x02
_021BAE38:
	.byte 0x64, 0xB1, 0x1B, 0x02
_021BAE3C:
...
_021BAE68:
	.byte 0x70, 0x79, 0x04, 0x02, 0x0F, 0x00, 0x00, 0x00
