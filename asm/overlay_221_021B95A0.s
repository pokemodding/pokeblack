...
FUN_overlay_221__021b95a0: ; 0x021B95A0
	...
	mov r5, #2
	blx FUN_0204047C
	ldr r0, _021B972C ; =DAT_overlay_d_221__021b98fd
	add r1, r7, #0
	mov r2, #1
	bl FUN_020056A0
	str r0, [r7, #0x14]
...
_021B973C:
	.byte 0xC0, 0xA2, 0x1B, 0x02
_021B9740:
	.byte 0xC4, 0xA2, 0x1B, 0x02
_021B9744:
	.byte 0xC8, 0xA2, 0x1B, 0x02, 0xF8, 0xB5
_021B974A:
...
_021B97BC:
	.byte 0x50, 0x10, 0x00, 0x04
_021B97C0:
	.byte 0xFF, 0x1F, 0xFF, 0xFF, 0x70, 0xB5, 0x82, 0xB0, 0x0C, 0x1C, 0x20, 0x68, 0x1D, 0x1C, 0x06, 0x28
	.byte 0x7C, 0xD8, 0x00, 0x18, 0x78, 0x44, 0xC0, 0x88, 0x00, 0x04, 0x00, 0x14, 0x87, 0x44, 0x0C, 0x00
...
_021B98F8:
	...
	thumb_func_start DAT_overlay_d_221__021b98fd
DAT_overlay_d_221__021b98fd: ; 0x021B98FC
	bx lr
	.balign 4, 0
	thumb_func_end DAT_overlay_d_221__021b98fd
...
_021B9C40:
	.byte 0xD8, 0xA2, 0x1B, 0x02
_021B9C44:
	.byte 0x6C, 0x25, 0x00, 0x00
_021B9C48:
	.byte 0x74, 0x4A, 0x00, 0x00
...
_021B9F14:
	.byte 0xFF, 0x1F, 0xFF, 0xFF
_021B9F18:
	.byte 0x20, 0xA2, 0x1B, 0x02
_021B9F1C:
	.byte 0x9D, 0x9F, 0x1B, 0x02
...
_021B9F98:
	.byte 0xC1, 0xA0, 0x1B, 0x02, 0x10, 0xB5, 0x0C, 0x1C
...
_021B9FD2:
	...
	pop {r3, r4, r5, r6, r7, pc}
_021BA008:
	.byte 0xD4, 0xA1, 0x1B, 0x02
_021BA00C:
	.byte 0x50, 0xA2, 0x1B, 0x02
...
_021BA118:
	.byte 0xD5, 0x9D, 0x1B, 0x02
_021BA11C:
	.byte 0xBC, 0xA1, 0x1B, 0x02
_021BA120:
	.byte 0xB0, 0xA1, 0x1B, 0x02
_021BA124:
	.byte 0xB8, 0x1E, 0x0A, 0x02
_021BA128:
	.byte 0xC8, 0xA1, 0x1B, 0x02
_021BA12C:
...
_021BA174:
	...
	non_word_aligned_thumb_func_start DAT_overlay_d_221__021ba177
DAT_overlay_d_221__021ba177: ; 0x021BA176
	lsl r0, r0, #4
	thumb_func_end DAT_overlay_d_221__021ba177

	thumb_func_start DAT_overlay_d_221__021ba179
DAT_overlay_d_221__021ba179: ; 0x021BA178
	lsr r1, r0, #0x1c
	.balign 4, 0
	thumb_func_end DAT_overlay_d_221__021ba179

	thumb_func_start DAT_overlay_d_221__021ba17d
DAT_overlay_d_221__021ba17d: ; 0x021BA17C
	lsl r0, r0, #8
	thumb_func_end DAT_overlay_d_221__021ba17d

	non_word_aligned_thumb_func_start DAT_overlay_d_221__021ba17f
DAT_overlay_d_221__021ba17f: ; 0x021BA17E
	add r0, r0, r0
	thumb_func_end DAT_overlay_d_221__021ba17f

	thumb_func_start DAT_overlay_d_221__021ba18
DAT_overlay_d_221__021ba18: ; 0x021BA180
	lsl r1, r0, #4
	thumb_func_end DAT_overlay_d_221__021ba18

	non_word_aligned_thumb_func_start DAT_overlay_d_221__021ba183
DAT_overlay_d_221__021ba183: ; 0x021BA182
	lsl r7, r1, #0
	lsl r0, r0, #0
	lsl r2, r0, #4
	sub r3, r0, #0
	...
	lsl r7, r1, #0
	lsl r0, r0, #0
	thumb_func_end DAT_overlay_d_221__021ba183
_021BA198:
