...
FUN_02006E40: ; 0x02006E40
	...
	mov r1, #0xc
	mov r2, #0
	.hword 0xF029, 0xEC72 ; blx FUN_02030734
	add r1, r4, #0
	add r5, r0, #0
	bl FUN_02006ea4
	add r0, r5, #0
...
FUN_02006E64: ; 0x02006E64
	...
	add r4, r0, #0
	ldr r0, [r4, #4]
	.hword 0xF029, 0xECA2 ; blx FUN_020307b0
	ldr r0, [r4, #8]
	blx FUN_020307b0
	add r0, r4, #0
	.hword 0xF029, 0xEC9C ; blx FUN_020307b0
	pop {r4, pc}
...
FUN_02006ea4: ; 0x02006EA4
	...
	mov r2, #0
	add r6, r4, #1
	.hword 0xF029, 0xEC34 ; blx FUN_02030734
	str r0, [r5, #4]
	mov r0, #0xb0
	str r0, [sp]
	ldrb r1, [r5]
...
FUN_02007084: ; 0x02007084
	...
	blx FUN_0203195c
	ldr r0, [r4]
	.hword 0xF029, 0xEB8C ; blx FUN_020307b0
	mov r0, #0
	str r0, [r4]
_0200709E:
	pop {r4, pc}
