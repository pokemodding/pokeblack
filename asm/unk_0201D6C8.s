...
FUN_0201d806: ; 0x0201D806
	.hword 0xF012, 0xEF96 ; blx FUN_02030734
	add r4, r0, #0
	beq _0201D830
	add r0, r6, #0
	add r1, r5, #0
...
_0201D898:
	...
	add r1, r6, #0
	mov r2, #0
	.hword 0xF012, 0xEF44 ; blx FUN_02030734
	add r1, r5, #0
	add r1, #0x84
	str r0, [r1]
...
_0201D94C:
	...
	add r0, r7, #0
	mov r2, #0
	.hword 0xF012, 0xEEE6 ; blx FUN_02030734
	add r1, r5, #0
	add r1, #0x90
	str r0, [r1]
	ldr r0, [r5, #0x50]
...
FUN_0201d984: ; 0x0201D984
	...
	add r0, r7, #0
	mov r2, #0
	.hword 0xF012, 0xEED4 ; blx FUN_02030734
...
_0201D9D8:
	...
	cmp r0, #0
	beq _0201D9E6
	.hword 0xF012, 0xEEE6 ; blx FUN_020307b0
_0201D9E6:
	add r0, r4, #0
	add r0, #0x88
	ldr r0, [r0]
